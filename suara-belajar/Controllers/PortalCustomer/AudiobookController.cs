    ...
    public class AudiobookController : Controller
    {
        ...
        private object GetPackageInfo(SqlConnection conn, string packageId)
        {
            ...
            using var cmd = new SqlCommand(@"
                SELECT package_id, name, logo_image, is_series, explorer_styling_version, header_title
                FROM mst_package
            ...
            if (reader.Read())
            {
                return new
                {
                    ...
                    header_title = reader["header_title"].ToString(),
                };
            }
            return null;
        }
        ...
        public IActionResult ExplorerTrial([FromBody] RequestDto req)
        {
            ...
            string sql = @"
        SELECT audiobook_id, title, cover_image, package_name, header_title
        ...
        SELECT 
            ...
            duration
        FROM txn_audiobook_trial
        WHERE audiobook_id = @audiobook_id
    ";
